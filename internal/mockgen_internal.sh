...
TEMP_DIR=$(mktemp -d)
mkdir -p $TEMP_DIR/src/github.com/attenberger/quic-go/internalpackage
...
cp -r $GOPATH/src/github.com/attenberger/quic-go/internal/* $TEMP_DIR/src/github.com/attenberger/quic-go/internalpackage
